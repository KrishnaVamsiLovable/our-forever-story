  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        <motion.h1
          className="font-serif text-5xl md:text-7xl lg:text-8xl font-medium mt-4 mb-6 tracking-tight"
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 1, delay: 0.5 }}
        >
          <span className="text-foreground">Emma</span>
          <motion.span 
        ...
        <motion.p
          className="font-script text-2xl md:text-3xl text-sage mb-4"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          The Rosewood Estate • Napa Valley, California
        </motion.p>
      </div>
