    ...
    <section className="py-24 md:py-32 px-6 bg-champagne/50">
      ...
      >
        ...
        <div className="space-y-6 text-muted-foreground leading-relaxed text-lg">
          <p>
            Our story began the way the most beautiful ones often do, unexpectedly. An impromptu trip, a spontaneous choice, a moment neither of us planned… and yet, it changed everything. At the time, we didn't know that a single unplanned decision would quietly lead us to the love of our lives. But fate, it seems, loves surprises.
          </p>

          <p>
            From that moment on, life unfolded in the most magical way. What followed became the most beautiful chapter we've ever known, filled with endless conversations, shared laughter, quiet comforts, and dreams spoken out loud. We found ourselves wanting to be together in every moment, in every joy and every pause in between.
          </p>

          <p>
            Somewhere along the way, we realized this was it. That partnership, love, and home all felt the same when we were together. This is how we want to walk through life, side by side.
          </p>
