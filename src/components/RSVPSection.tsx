...
const RSVPSection = () => {
  ...
  return (
    <section className="relative py-20 md:py-28 px-6 bg-cover bg-center bg-no-repeat bg-sage-light/10" style={{ backgroundImage: "url('/decorative-bg.png')" }}>
      <div
      ...
      <motion.div
        ref={headerRef}
        className="relative z-10 max-w-3xl mx-auto text-center mb-12 md:mb-16"
